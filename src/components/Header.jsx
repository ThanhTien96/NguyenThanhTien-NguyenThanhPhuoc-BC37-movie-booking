      ...
      <div className="container md:flex justify-between h-14 mx-auto items-center">
        ...
        <ul
          ...
          <li className='navItem'>
            <NavLink to={'/'} 
            onClick={() => scrollToView('cumRap')}
            className='navLink text-white hover:text-black md:hover:text-orange-400 transition-all' href="">Cụm Rạp</NavLink>
          </li>
          <li className='navItem'>
            <NavLink to={'/'} 
            onClick={() => scrollToView('lichChieu')}
            className='navLink text-white hover:text-black md:hover:text-orange-400 transition-all' href="">Lịch Chiếu</NavLink>
          </li>
          <li className='navItem'>
            <NavLink to={''}
            onClick={() => scrollToView('tinTuc24h')}
            className='navLink text-white hover:text-black md:hover:text-orange-400 transition-all' href="">Tin Tức</NavLink>
          </li>
          <li className='navItem'>
            <NavLink to={''}
            onClick={() => scrollToView('ungDung')}
            className='navLink text-white hover:text-black md:hover:text-orange-400 transition-all' href="">Ứng Dụng</NavLink>
          </li>
          <li className='navItem'>
            <NavLink to={'/admin'}
            onClick={handleShow}
